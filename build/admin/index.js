...
/* harmony import */ var _areas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../areas */ "./src/admin/areas.ts");
/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../canvas */ "./src/admin/canvas.ts");
/* harmony import */ var _shared_map_geometry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/map-geometry */ "./src/shared/map-geometry.ts");
/* harmony import */ var _CanvasZoomWrap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CanvasZoomWrap */ "./src/admin/app/canvases/CanvasZoomWrap.tsx");
...
function drawRegion(ctx, region, W, H, isSelected, repoNodeIdx, repoCursor) {
  ...
  if (liveNodes.length >= minNodesFor(shapeType)) {
    ...
    (0,_shared_map_geometry__WEBPACK_IMPORTED_MODULE_3__.buildAreaPathFromNodes)(ctx, liveNodes, shapeType, W, H);
    ctx.save();
    ...
    if (region.child_map_title) {
      const cx = shapeType === 'CIRCLE' ? liveNodes[0].x * W : liveNodes.reduce((s, n) => s + n.x, 0) / liveNodes.length * W;
      const cy = shapeType === 'CIRCLE' ? liveNodes[0].y * H : liveNodes.reduce((s, n) => s + n.y, 0) / liveNodes.length * H;
      ctx.save();
...
function findRegionAtPoint(ctx, x, y, regions, W, H) {
  for (let i = regions.length - 1; i >= 0; i--) {
    ...
    (0,_shared_map_geometry__WEBPACK_IMPORTED_MODULE_3__.buildAreaPathFromNodes)(ctx, nodes, shapeType, W, H);
