...
/* harmony import */ var _forms_HierarchyRegionForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./forms/HierarchyRegionForm */ "./src/admin/app/forms/HierarchyRegionForm.tsx");
/* harmony import */ var _forms_NodeList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./forms/NodeList */ "./src/admin/app/forms/NodeList.tsx");
/* harmony import */ var _shared_SaveStatus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/SaveStatus */ "./src/admin/app/shared/SaveStatus.tsx");
...
function ContextPanel({
  ...
  const [icons, setIcons] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(_icons__WEBPACK_IMPORTED_MODULE_6__.iconLibraryCache || []);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (selectedObject) {
      ...
      if (!_icons__WEBPACK_IMPORTED_MODULE_6__.iconLibraryCache) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (selectedRegion) {
      setRegionFormData((0,_forms_HierarchyRegionForm__WEBPACK_IMPORTED_MODULE_3__.defaultHierarchyFormData)(selectedRegion));
      setStatus({
        text: '',
        type: ''
      });
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("aside", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
          children: activeTab === 'areas' ? 'Select an area on the canvas to edit it here.' : activeTab === 'hierarchy' ? 'Select a region on the canvas to edit it here.' : 'Select an object on the canvas to edit it here.'
        })
      })
    });
  }
  ...
  const title = isObject ? selectedObject.title || '(no title)' : isRegion ? selectedRegion.child_map_title || 'New Region' : selectedArea.title || '(no title)';
  async function handleSave() {
    ...
    try {
      if (isObject && objFormData) {
        ...
        if (data) setRegionFormData((0,_forms_HierarchyRegionForm__WEBPACK_IMPORTED_MODULE_3__.defaultHierarchyFormData)(data));
  ...
  function handleClose() {
    if (isObject) onObjectClose();else if (isRegion) onRegionClose();else onAreaClose();
  }
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("aside", {
    className: "cns-editor-context",
    "aria-label": "Context panel",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        ...
        children: [isObject && objFormData && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_forms_ObjectForm__WEBPACK_IMPORTED_MODULE_1__["default"], {
          formData: objFormData,
          onChange: setObjFormData,
          icons: icons
        }), !isObject && !isRegion && areaFormData && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_forms_AreaForm__WEBPACK_IMPORTED_MODULE_2__["default"], {
          ...
          }), selectedArea && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_forms_NodeList__WEBPACK_IMPORTED_MODULE_4__["default"], {
            area: selectedArea,
            onNodesChange: nodes => onAreaNodesUpdate?.(selectedArea.id, nodes)
          })]
        }), isRegion && regionFormData && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_forms_HierarchyRegionForm__WEBPACK_IMPORTED_MODULE_3__["default"], {
          formData: regionFormData,
          onChange: setRegionFormData
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        className: "cns-editor-context__footer",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_SaveStatus__WEBPACK_IMPORTED_MODULE_5__["default"], {
          text: status.text,
          type: status.type
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("button", {
          type: "button",
...
function MapEditorApp() {
  ...
  async function handleRegionSave(formData) {
    ...
    if (selectedRegionId === -1) {
      ...
      res = await (0,_utils__WEBPACK_IMPORTED_MODULE_9__.apiFetch)('POST', `/maps/${mapId}/hierarchy`, payload);
    } else {
      res = await (0,_utils__WEBPACK_IMPORTED_MODULE_9__.apiFetch)('POST', `/hierarchy/${selectedRegionId}`, payload);
    }
    const data = await res.json();
    if (!res.ok) throw new Error(data.message || 'Save failed.');
  ...
  async function handleRegionDeleteById(id) {
    ...
    const res = await (0,_utils__WEBPACK_IMPORTED_MODULE_9__.apiFetch)('DELETE', `/hierarchy/${id}`);
    if (!res.ok) throw new Error('Delete failed.');
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_EditorHeader__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_TabBar__WEBPACK_IMPORTED_MODULE_2__["default"], {
          ...
          }), (activeTab === 'hierarchy' || settings.isMaster && activeTab !== 'settings' && activeTab !== 'preview') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_panels_HierarchyPanel__WEBPACK_IMPORTED_MODULE_7__["default"], {
            mapId: mapId,
            settings: settings,
            regions: regionsList,
          ...
          }), activeTab === 'preview' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_panels_PreviewPanel__WEBPACK_IMPORTED_MODULE_8__["default"], {
            settings: settings,
            objects: objectsList,
            areas: areasList,
            viewUrl: !isNew && viewUrl ? viewUrl : ''
          }), activeTab === 'stories' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("div", {
...
function MapSearch({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("label", {
      ...
      children: results.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
        type: "button",
        className: "cns-post-result",
        onClick: () => selectResult(item),
        children: item.title
      }, item.id))
    }), childMapId > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("p", {
      className: "description",
      children: [childMapLabel || `Map ID: ${childMapId}`, ' ', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
        type: "button",
        className: "button button-small",
        onClick: () => onChange({
          id: 0,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("section", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("h3", {
        children: "Child Map"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(MapSearch, {
...
function HierarchyPanel({
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (initialized || !mapId) return;
    (0,_utils__WEBPACK_IMPORTED_MODULE_3__.apiFetch)('GET', `/maps/${mapId}/hierarchy`).then(r => r.json()).then(data => {
      if (Array.isArray(data)) onRegionsLoaded(data);
    }).catch(() => {}).finally(() => setInitialized(true));
  }, [mapId]);
  async function handleAddRegion() {
    ...
    const draft = {
      ...
      parent_map_id: mapId,
      child_map_id: 0,
      nodes: (0,_areas__WEBPACK_IMPORTED_MODULE_5__.getDefaultNodes)('POLYGON'),
      canvas_styles: {
        fill: '#e8a020',
        fillOpacity: 0.25,
        stroke: '#e8a020',
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
      ...
      children: [parentMaps.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("button", {
          ...
          className: "description",
          children: "Draw a polygon region that links to a child map. Click a node to reposition it; click empty canvas on a selected region to add a node."
        })]
